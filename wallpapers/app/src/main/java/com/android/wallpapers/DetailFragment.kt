package com.android.wallpapers
...
class DetailFragment : Fragment(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v!!.id) {
            R.id.detail_set_btn -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                setWallpaper()
            }
        }
    }
    ...
    private fun setWallpaper() {
        ...
        detail_set_btn.setTextColor(resources.getColor(R.color.black, null))
